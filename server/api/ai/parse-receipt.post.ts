...
4. description (Описание - главный заголовок):
...
5. comment (Комментарий - подзаголовок):
   - Любое дополнительное описание операции.
   - Например, сообщение к переводу ("За пиццу", "С днем рождения"), или тип операции ("Возврат средств", "Перевод через СБП", "Комиссия").
   - Если дополнительной информации нет, верни пустую строку "".
...
7. date (Дата):
   - Формат YYYY-MM-DD. Ищи дату на изображении. Если её нет, верни пустую строку "".
